            ...
            <div className="bg-box rounded-lg p-4 max-w-md w-2/5 flex flex-col items-center">
                <form onSubmit={handleSubmit} className="w-full max-w-xs">
                    <div className="mb-1">
                        ...
                        <input type="text" id="name" name="name" className="w-full px-3 py-2 font-custom border rounded-lg focus:outline focus:border-blue-500" />
                    </div>
                    <div className="mb-1">
                        <label htmlFor="robot" className="block text-sm font-custom mb-1">Robot Number:</label>
                        <input type="text" id="robot" name="robot" className="w-full px-3 py-2 font-custom border rounded-lg focus:outline focus:border-blue-500" />
                    </div>
                    <div className="mb-1">
                    ...
                    <div className="mb-1">
                        ...
                        <input type="password" id="password" name="password" className="w-full px-3 py-2 font-custom border rounded-lg focus:outline focus:border-blue-500" />
                    </div>
                    <div className="mb-1">
                        <label htmlFor="confirmpassword" className="block text-sm font-custom mb-1">Confirm Password:</label>
                        <input type="password" id="confirmpassword" name="confirmpassword" className="mb-4 w-full px-3 py-2 font-custom border rounded-lg focus:outline focus:border-blue-500" />
                    </div>
